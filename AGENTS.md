...
## ⚠️ 开发铁律（2026-08-28 商陆定）

- **代码优先找开源现成的：能抄就抄，能改写就改写，不自创代码**
- 优先级：① 官方文档/官方示例 → ② 开源项目（GitHub 搜 star 高、维护活跃的）→ ③ 论坛/博客成熟方案 → ④ 实在没办法才自己写新代码
- 每次引用开源代码，注明来源（仓库地址/文档链接），方便回查和合规
...
- [ ] 真实可视化作品（ECharts 交互）
- [ ] 关于我放公众号二维码
- [ ] 迁移 Cloudflare Pages（github.io 国内被墙，手机需代理；读者无代理打不开；商陆手机开代理可访问 github.io 但慢）
- [ ] GitHub 部署上线
